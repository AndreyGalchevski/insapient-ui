...
function PrivacyPolicy() {
  return (
    <section className="privacy-policy">
      <Header pageTitle="Privacy Policy" isMobileOnly={false} />
      <div className="privacy-policy-container">
        <p>
          This Privacy Policy describes how your personal information is collected, used, and shared
          when you visit or make a purchase from www.insapient.band (the “Site”).
        </p>
        ...
        <p>
          “LocalStorage” is used to create a better shopping experience by saving the selected items
          into a “cart”, using Your browser’s storage capabilities. After the purchase is complete
          the items saved in LocalStorage are deleted. Additionaly, by removing items from the
          “cart” you also remove them from your browsers LocalStorage. For more information about
          LocalStorage, visit <a href="https://en.wikipedia.org/wiki/Web_storage">here</a>.
        </p>
        <p>
          Additionally when you make a purchase or attempt to make a purchase through the Site, we
          collect certain information from you, including your name, email address, phone number,
          shipping address and payment confirmation information received from PayPal after the
          purchase is complete (we do not save or see your payment information like credit card
          numbers etc). We refer to this information as “Order Information.”
        </p>
        <p>
        ...
        <p>
          ...
          Order Information to communicate with you and screen our orders for potential risk or
          fraud. We use the Device Information that we collect to help us screen for potential risk
        ...
        <p>
          ...
          Information, as described above. For example, we use PayPal to make transactions in our
          online store--you can read more about how PayPal uses your Personal Information{' '}
          <a href="https://www.paypal.com/il/webapps/mpp/ua/privacy-full">here</a>. We also use
          Google Analytics to help us understand how our customers use the Site--you can read more
          about how Google uses your Personal Information{' '}
          <a href="https://www.google.com/intl/en/policies/privacy">here</a>. You can also opt-out
          of Google Analytics <a href="https://tools.google.com/dlpage/gaoptout">here</a>.
        </p>
        <p>
        ...
        <p>
          ...
          like to make a complaint, please contact us by e-mail at insapient.band@gmail.com or by
